...
/**
 * 
 * @returns all appointment stadistics needed for admin module
 */
export async function get_appointment_stadistics() {
    try {
        const response = await fetch(`${host}stadistics/appointmentsStadistics`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
