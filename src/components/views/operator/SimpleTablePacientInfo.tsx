...
import { get_all_pacients } from "../../../services/core/users.service";
...
function SimpleTablePacientInfo() {
    ...
    const columns = [
        ...
        },
        {
            ...
            accessorKey: "cv",
            cell: () => (
                <button className="group-hover:border-white border-black border rounded-full px-3 py-1 shadow-customButton hover:bg-white hover:text-black">Ver hoja de vida</button>
            )
        },
    ];
